...
# ![](images/alocacio%CC%81n%20cartera%20agresiva.png)Efectos sobre un portafolio
...
plot.xts(mulvaney, main = 'MULVANEY: Asset Under management ( mm de U$S)', type = 'h')
```
...
![](images/DUNN-Information-February-2021.webp)
